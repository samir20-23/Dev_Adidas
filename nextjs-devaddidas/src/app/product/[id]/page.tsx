            ...
            <div className="product-info-section">
                ...
                <div className="color-section">
                    <label className="section-label">
                        {t('product.colors')} : <span className="selected-value">{selectedColor.charAt(0).toUpperCase() + selectedColor.slice(1)}</span>
                    </label>
                ...
                <div className="product-details-section">
                    ...
                    <p className="details-text">
                        Step into speed with the Men's Adizero EVO SL Running Shoes by adidas. Designed for performance, these lightweight trainers combine agility and comfort for your daily runs. Featuring a breathable mesh upper and responsive cushioning, they help you achieve your best with every stride...
                ...
                <div className="delivery-section">
                    ...
                    <p className="delivery-text">
                        Free delivery available for orders over $50. Standard delivery takes 3-5 business days. Express shipping options available at checkout.
                    </p>
                </div>
